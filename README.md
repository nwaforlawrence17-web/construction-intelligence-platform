...
`python` | `pandas` | `pytest` | `data-engineering` | `currency-normalization` | `risk-management` | `plotly`

---

## 🔗 Live Demo
Access the interactive dashboard and full case study:  
👉 **[chinua-data-portfolio.vercel.app](https://chinua-data-portfolio.vercel.app/projects.html#project-construction-intel)**
